...
class ForkJoinDemo {
    public static void main(String args[]) {
        // Create a task pool.
        ForkJoinPool fjp = new ForkJoinPool();//java8中也可以使用公共池 ForkJoinPool fjp = ForkJoinPool.commonPool();
        ...
        fjp.invoke(task);//java8中也可以不需要公共池的引用, 直接task.invoke()将自动使任务在公共池中执行.
